...
get_version("sPyNNakerExtraModelsPlugin")
# get_version("sPyNNaker7ExtraModelsPlugin")
# get_version("sPyNNaker8ExtraModelsPlugin")
get_version("sPyNNakerExternalDevicesPlugin")
get_version("sPyNNaker8ExternalDevicesPlugin")
get_version("sPyNNaker7ExternalDevicesPlugin")
print versions
